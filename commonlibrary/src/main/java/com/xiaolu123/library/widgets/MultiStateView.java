...
public class MultiStateView extends FrameLayout {
    ...
    private boolean mLoadingViewOverlay;
    ...
    private void setView() {
        switch (mViewState) {
            case VIEW_STATE_LOADING:
                ...
                if (mContentView != null && !mLoadingViewOverlay) mContentView.setVisibility(View.GONE);
    ...
    /**
     * loadingView覆盖再contentView上
     *
     * @param overlay
     */
    public void setLoadingViewOverlay(boolean overlay) {
        mLoadingViewOverlay = overlay;
    }
